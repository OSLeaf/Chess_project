...
def main():
    ...
    l1 = keras.layers.Conv2D(256, kernel_size=(3, 3), strides=1, activation='relu', padding='same')(inp)
    l2 = keras.layers.Conv2D(256, kernel_size=(3, 3), strides=1, activation='relu', padding='same')(l1)
    l3 = keras.layers.Conv2D(256, kernel_size=(3, 3), strides=1, activation='relu', padding='same')(l2)
    ...
    up1 = keras.layers.Conv2D(256, kernel_size=(3, 3), strides=1, activation = 'relu', padding = 'same')(keras.layers.UpSampling2D(size = (1,1))(l6))
    merge1 = keras.layers.concatenate([l5,up1], axis = 1)
    up2 = keras.layers.Conv2D(256, kernel_size=(3, 3), strides=1, activation = 'relu', padding = 'same')(keras.layers.UpSampling2D(size = (1,1))(merge1))
    merge2 = keras.layers.concatenate([l4,up2], axis = 1)
    up3 = keras.layers.Conv2D(256, kernel_size=(3, 3), strides=1, activation = 'relu', padding = 'same')(keras.layers.UpSampling2D(size = (1,1))(merge2))
    merge3 = keras.layers.concatenate([l3,up3], axis = 1)
    ...
    policy_conv = keras.layers.Conv2D(2, kernel_size=(1, 1), strides=1, activation='relu')(merge5)
    ...
    value_conv = keras.layers.Conv2D(1, kernel_size=(1, 1), strides=1, activation='relu')(merge5)
