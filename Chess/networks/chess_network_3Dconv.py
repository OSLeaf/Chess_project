...
def main():
    ...
    value_conv = keras.layers.Conv3D(1, kernel_size=(1, 1, 1), strides=1, activation='relu')(act6)
    ...
    model.save('Chess/networks/random_model_3D.keras')
