...
def Evaluate(game_amount, network1 = None, network2 = None):
    ...
    for i in range(0,game_amount):
        ...
        while((not board.is_game_over() and not board.material_count_under_seven() and board.fullmove_number < 10)):
...
def main():
    ...
    #Evaluate(100, network2=NeuralNetwork('Chess/networks/t170.keras'), network1=Quesser() )
    Evaluate(50, network1=NeuralNetwork('Chess/networks/t170.keras'), network2=NeuralNetwork('Chess/networks/t250.keras') )
    Evaluate(50, network2=NeuralNetwork('Chess/networks/t170.keras'), network1=NeuralNetwork('Chess/networks/t250.keras') )
